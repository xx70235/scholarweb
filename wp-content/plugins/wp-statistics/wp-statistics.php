 ...
 */
	...
	function wp_statistics_post_init() {
		...
		$id = $post->ID;
        echo "<div class='misc-pub-section'>" . "统计详情:点击" . ": <b><a href='" . get_admin_url() . "admin.php?page=" . WP_STATISTICS_PAGES_PAGE . "&page-id={$id}'>" . wp_statistics_pages( 'total', "", $id ) . "</a></b></div>";
