...
?>
	...
	<div class="entry-content" itemprop="text">
        ...
        <div id="location">
            <span class="location" ><h4><?php pll_e('工作地点：'); $terms = wp_get_post_terms( $post->ID, array( 'location') ); ?>
...
<!--	           <p> </p>-->
        ...
        <div id="job-title">
            <span class="job-title" ><h4><?php pll_e('职位：');  $terms = wp_get_post_terms( $post->ID, array( 'job_title') ); ?>
		            <?php foreach ( $terms as $term ) : ?>
