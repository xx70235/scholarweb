 ...
 */
function agencystrap_pricing_table_standard_widget() {
	register_widget( 'Pricing_Table_Standard' );
}
add_action( 'widgets_init', 'agencystrap_pricing_table_standard_widget' );
...
class Pricing_Table_Standard extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __( 'Used to display a pricing table by comparing multiple downloads. Add multiple instances of this widget to the Pricing Page Widget area to build a pricing table.', 'agencystrap' ),
		);
		...
		parent::__construct( 'pricing-table-standard', __( 'agencystrap: Pricing Table', 'agencystrap' ), $widget_ops, $control_ops );
 ...
 ?>
		<div itemscope class="pricing-table <?php echo $featured; ?>">
			...
			<div class="pricing-table-features">
				<?php agencystrap_edd_download_details( $download_id ); ?>
				<a class="button" href="<?php echo edd_get_agencystrap_uri(); ?>?edd_action=add_to_cart&amp;download_id=<?php echo absint( $download_id ); ?>" title="<?php echo esc_attr( $title ); ?>">
			...
			<div class="standard-price-table-widget-column-box standard-price-table-widget-column-box-top">
				...
				<p class="featured-download-wrapper">
					...
					<label for="<?php echo esc_attr( $this->get_field_id( 'featured' ) ); ?>">
						<?php printf( __( 'Feature this %s in the pricing table?', 'agencystrap' ), edd_get_label_singular() ); ?>
					</label>
				</p>
