...
function _wp_post_thumbnail_html( $thumbnail_id = null, $post = null ) {
	...
	$set_thumbnail_link = '<p class="hide-if-no-js"><a href="%s" id="set-post-thumbnail"%s class="thickbox">%s</a></p><p><a class="btn" data-popup-open="popup-1" href="#">点击这里查看如何获取高清校徽</a></p>';
